...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice dribbling, passing, and team strategy in competitive matches",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Improve shooting, defense, and game play through drills and scrimmages",
